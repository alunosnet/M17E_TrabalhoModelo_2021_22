...
namespace M17E_TrabalhoModelo_2021_22.Models
{
    public class Quarto
    {
        ...
        [Required(ErrorMessage = "Tem que indicar o piso do quarto")]
        ...
        [Range(0,1000,ErrorMessage = "O preço deve superior ou igual a 0 e inferior ou igual a 1000")]
        ...
        [StringLength(20)]
        [MinLength(3, ErrorMessage = "O tipo tem de ter 3 letras")]
